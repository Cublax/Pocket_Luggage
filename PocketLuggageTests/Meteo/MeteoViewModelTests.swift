...
fileprivate final class MockMeteoRepository: MeteoRepositoryType {
    func getForecastMeteoBerlin(completion: @escaping (Weather) -> Void) {
        completion(Weather(forecasts: [Forecast(dt: 1, main: ForecastMainClass(temp: 1, tempMin: 1, tempMax: 1), weather: [ForecastWeather(weatherDescription: "1", icon: "1")], dtTxt: "2019-10-04 12:00:00")], city: City(name: "Berlin", country: "DE", population: 1, timezone: 1, sunrise: 1570165907, sunset: 1570165907)))
    }
    
    func getForecastMeteoAnnecy(completion: @escaping (Weather) -> Void) {
        completion(Weather(forecasts: [Forecast(dt: 2, main: ForecastMainClass(temp: 2, tempMin: 2, tempMax: 2), weather: [ForecastWeather(weatherDescription: "2", icon: "2")], dtTxt: "2019-10-04 12:00:00")], city: City(name: "Annecy", country: "FR", population: 2, timezone: 2, sunrise: 1570165907, sunset: 1570165907)))
    }
}
...
fileprivate final class MockMeteoRepository2: MeteoRepositoryType {
    ...
    func getForecastMeteoAnnecy(completion: @escaping (Weather) -> Void) {
        completion(Weather(forecasts: [Forecast(dt: 2,
...
final class MeteoViewModelTests: XCTestCase {
    ...
    func testGivenAViewModelWhenViewDidLoadThenWeatherItemIsCorrectlyCreated() {
        ...
        let viewModel = MeteoViewModel(repository: mockRepository)
